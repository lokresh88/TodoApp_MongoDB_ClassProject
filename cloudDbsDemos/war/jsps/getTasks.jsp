...
%>
<div class="row" id="task_<%=id%>" taskObj='<%=taskObj.toString()%>' taskid="<%=id%>"><input type="checkbox" onclick="completeTask(this)"><span><%=taskName%></span> <%if(taskDate!=""){ %><i>overdue on</i> <span><%=taskDate%></span><%}%><span class="prir"><%if(prior==2){%><img style="height: 22;" src="../images/highPriority.png"/><%}%><%if(prior==0){%><img style="height: 22;" src="../images/lowPriority.png"/><%}%></span><span class="edit sh"><img style="height: 15;" src="../images/deleteIcon.png" onclick="deleteTask(this)"/></span><span class="edit sh"><img style="height: 15;" src="../images/taskEditImage.png" onclick="editTask(this)"/></span></div><% } %>
</div>	
...
for(int i=0;i<pendingList.size();i++){
	...
	JSONObject taskObj = DBUtil.getJSONObject(task);
%>
<div class="row" id="task_<%=id%>" taskObj='<%=taskObj.toString()%>' taskid="<%=id%>"><input type="checkbox" onclick="completeTask(this)"><span><%=taskName%></span> <%if(taskDate!=""){ %><i>pending on</i> <span><%=taskDate%></span><%}%><span class="prir"><%if(prior==2){%><img style="height: 22;" src="../images/highPriority.png"/><%}%><%if(prior==0){%><img style="height: 22;" src="../images/lowPriority.png"/><%}%></span><span class="edit sh"><img style="height: 15;" src="../images/deleteIcon.png" onclick="deleteTask(this)"/></span><span class="edit sh"><img style="height: 15;" src="../images/taskEditImage.png" onclick="editTask(this)"/></span></div><% } %>
</div>
...
for(int i=0;i<completedList.size();i++){
	...
	JSONObject taskObj =DBUtil.getJSONObject(task);
%>
<div class="row" id="task_<%=id%>" taskObj='<%=taskObj.toString()%>' taskid="<%=id%>"><span><%=taskName%></span> <%if(taskDate!=""){ %><i>for </i> <span><%=taskDate%></span><%}%><span class="prir"><%if(prior==2){%><img style="height: 22;" src="../images/highPriority.png"/><%}%><%if(prior==0){%><img style="height: 22;" src="../images/lowPriority.png"/><%}%></span><span class="edit sh"><img style="height: 15;" src="../images/deleteIcon.png" onclick="deleteTask(this)"/></span><span class="edit sh"><img style="height: 15;" src="../images/taskEditImage.png" onclick="editTask(this)"/></span></div><% } %>
</div>	
</div>
